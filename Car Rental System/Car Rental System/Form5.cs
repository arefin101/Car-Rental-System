...
namespace Car_Rental_System
{
    public partial class Form5 : Form
    {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("select * from sdcar", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Generating SQL Query
            string sql = "INSERT sdreq(Brand,Model,Numberplate,Color,Driver,Drivercont,Deparature,Destination,Startdt,Enddt,Username) VALUES(@param1,@param2,@param3,@param4,@param5,@param6,@param7,@param8,@param9,@param10,@param11)";
